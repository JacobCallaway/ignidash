...
export default function SectionSelector({ activeSection, setActiveSection }: SectionSelectorProps) {
  ...
  return (
    <>
      <div className="border-border/50 from-emphasized-background to-background fixed top-[4.0625rem] z-30 -mx-2 w-full border-b bg-gradient-to-bl py-2 group-data-[animating=true]/sidebar:transition-[width] group-data-[animating=true]/sidebar:duration-200 group-data-[animating=true]/sidebar:ease-in-out motion-reduce:transition-none sm:-mx-3 lg:top-0 lg:-mx-4 lg:w-[calc(100%-18rem)] lg:py-4 lg:group-data-[state=collapsed]/sidebar:w-[calc(100%-4rem)]">
